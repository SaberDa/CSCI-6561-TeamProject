...
class App extends React.Component<AppProps, AppState> {
  ...
  render() {
    ...
    const emptyItem = {name: "NewNetwork", titleImg: "", url: "data/empty.json"}
      ...
      return (
        <Router basename="/">
          ...
          <Route key="contribute" path={"/contribute"}
                 component={() => <DocPage title="Contribute" sourceUrl={"docs/contribute.md"}/>} />
          <Route key="about" path={"/about"}
                 component={() => <DocPage title="About" sourceUrl={"docs/about.md"}/>}
                 />
        </Router>
      );
    }
