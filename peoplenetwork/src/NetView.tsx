...
const ViewControl = (props: ViewControlProps) => {
  ...
  return (
    <div className="viewControl">
      ...
      <Tooltip title="ScreenShot" placement="top"><PhotoCameraIcon onClick={() => props.captureImg()}/></Tooltip>
      ...
      />
      {fullScreenMode
      ? <Tooltip title="ExitFullScreen" placement="top"><FullscreenExitIcon onClick={exitFullScreen}/></Tooltip>
      : <Tooltip title="FullScreen" placement="top"><FullscreenIcon onClick={enterFullScreen}/></Tooltip>
      }
    </div>
  )
}
